...
namespace Project.Infrastructure.Services
{
    public sealed class CertificateService : ICertificateService
    {
        ...
        public CertificateService(RazorViewRenderer renderer, IConverter converter)
        {
            _renderer = renderer;
        ...
        {
            var html = await _renderer.RenderAsync("Certificate", user);
            ...
            var document = new HtmlToPdfDocument
            {
                GlobalSettings = new GlobalSettings
                {
                    ...
                    DocumentTitle = $"Certificate — {user.FullName}",
                },
                Objects =
                {
                    new ObjectSettings
